...
export function UserDetailsDialog({ staff, open, onOpenChange }: UserDetailsDialogProps) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Thông tin chi tiết của tài khoản người dùng. Admin chỉ có thể xem, không thể chỉnh sửa thông tin cá nhân.
                    </DialogDescription>
                </DialogHeader>
                        ...
                        <CardContent>
                            <div className="flex items-start gap-4">
                                <Avatar className="h-16 w-16">
                                    <AvatarImage src={staff.imageUrl || "/placeholder.svg"} alt={staff.fullName} />
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            <div className="flex items-center gap-3">
                                ...
                                <span>
                                    Ngày tạo: <strong>{formatDate(staff.createdAt)}</strong>
                                </span>
                            </div>
                            {staff.lastSignInAt && (
                                <div className="flex items-center gap-3">
                                    ...
                                    <span>
                                        Đăng nhập cuối: <strong>{formatDate(staff.lastSignInAt)}</strong>
                                    </span>
                                </div>
                            )}
                        </CardContent>
