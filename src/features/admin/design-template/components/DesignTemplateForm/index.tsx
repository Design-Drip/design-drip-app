...
const templateFormSchema = z.object({
  ...
  category: z.string().min(1, {
    message: 'Category is required and at least 2 characters'
  }),
})
                  ...
                  {watchedImageUrl ? (
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                      <UploadButton
                        ...
                        appearance={{
                          button: "ut-ready:bg-blue-500 ut-uploading:cursor-not-allowed bg-blue-500 bg-none after:bg-blue-400",
