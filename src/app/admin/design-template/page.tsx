...
import DesignTemplateForm, { TemplateFormData } from '@/features/admin/design-template/components/DesignTemplateForm'
...
import { DesignTemplateFiltersQuery, getDesignTemplatesQuery } from '@/features/admin/design-template/services/queries'
...
export default function DesignTemplatePage() {
    ...
    const filters: DesignTemplateFiltersQuery = useMemo(() => {
        ...
        return filterObj
    }, [debouncedSearchTerm, selectedCategory, selectedStatus, currentPage, itemsPerPage])
    ...
    const updateActiveStatusTemplateMutation = designTemplate.useUpdateActiveStatus()

    // Fetch templates with filters
    const { data, isLoading, isError, refetch } = useQuery(getDesignTemplatesQuery(filters))
