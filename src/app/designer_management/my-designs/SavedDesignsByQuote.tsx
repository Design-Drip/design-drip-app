                          ...
                          <div className="flex space-x-1">
                            {design.quote_id && (
                              <Button
                                ...
                                className={`h-8 w-8 p-0 ${design.quote_id.design_id && design.quote_id.design_id === getDesignId(design)
                              ...
                              >
                                <Star className={`h-4 w-4 ${design.quote_id.design_id && design.quote_id.design_id === getDesignId(design) ? "fill-current" : ""
                                  }`} />
                              </Button>
                            )}
                            <Button
